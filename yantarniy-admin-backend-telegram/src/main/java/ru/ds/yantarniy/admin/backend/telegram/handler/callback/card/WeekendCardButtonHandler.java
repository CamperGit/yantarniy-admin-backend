...
public class WeekendCardButtonHandler implements BotCallbackHandler {
    ...
    public void handle(YantarniyTelegramBot bot, Update update) throws TelegramApiException {
        ...
        String text = "<b><u>Карта выходного дня</u></b>\n" +
                "12 месяцев.\n" +
                "\n<b>Время посещения\n</b>" +
    ...
    public boolean isApplicable(String callback) {
        return CallbackValue.OPEN_WEEKEND_CARD_INFO.getValue().equals(callback);
    }
}
