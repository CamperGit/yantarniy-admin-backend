...
public class PriceSpaNailsButtonHandler implements BotCallbackHandler, ScrollHelperService<PriceEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<PriceEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_SPA_PRICE_NAILS.getValue(),
    ...
    public List<Specification<PriceEntity>> getAdditionalSpecifications() {
        return Collections.singletonList(
                Specifications.inOrReturnNull("location.type", Collections.singletonList(LocationType.NAILS.getCode()))
        );
    }
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_SPA_PRICE_NAILS.getValue());
    }
}
