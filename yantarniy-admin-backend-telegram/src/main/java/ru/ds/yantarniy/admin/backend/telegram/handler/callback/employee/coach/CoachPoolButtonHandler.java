...
public class CoachPoolButtonHandler implements BotCallbackHandler, ScrollHelperService<EmployeeEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<EmployeeEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_POOL_COACHES.getValue(),
    ...
    public List<Specification<EmployeeEntity>> getAdditionalSpecifications() {
        return Collections.singletonList(
                Specifications.inOrReturnNull("location.type", Collections.singletonList(LocationType.POOL.getCode()))
        );
    }
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_POOL_COACHES.getValue());
    }
}
