...
public class DayGoldCardButtonHandler implements BotCallbackHandler {
    ...
    public void handle(YantarniyTelegramBot bot, Update update) throws TelegramApiException {
        ...
        String text = "<b><u>Дневная GOLD</u></b>\n" +
                "6 месяцев.\n" +
                "12 месяцев.\n" +
                "\n<b>Время посещения\n</b>" +
    ...
    public boolean isApplicable(String callback) {
        return CallbackValue.OPEN_DAY_GOLD_CARD_INFO.getValue().equals(callback);
    }
}
