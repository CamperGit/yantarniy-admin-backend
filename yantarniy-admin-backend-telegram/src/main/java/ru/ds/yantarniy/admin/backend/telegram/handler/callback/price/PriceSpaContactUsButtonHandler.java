...
public class PriceSpaContactUsButtonHandler implements BotCallbackHandler {
    ...
    public void handle(YantarniyTelegramBot bot, Update update) throws TelegramApiException {
        ...
        bot.execute(SendMessage.builder()
                ...
                .replyMarkup(markupService.getReturnMarkup(CallbackValue.PRICE_SPA.getValue(), true))
                .build());
    }

    @Override
    public boolean isApplicable(String callback) {
        return CallbackValue.OPEN_PRICE_SPA_CONTACT_US.getValue().equals(callback);
    }
}
