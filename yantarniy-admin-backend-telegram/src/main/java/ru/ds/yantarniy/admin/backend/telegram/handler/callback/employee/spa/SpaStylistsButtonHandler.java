...
public class SpaStylistsButtonHandler implements BotCallbackHandler, ScrollHelperService<EmployeeEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<EmployeeEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_STYLISTS_SPA_SPECIALISTS.getValue(),
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_STYLISTS_SPA_SPECIALISTS.getValue());
    }
}
