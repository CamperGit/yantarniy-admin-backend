...
public class SpaNailsButtonHandler implements BotCallbackHandler, ScrollHelperService<EmployeeEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<EmployeeEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_NAILS_SPA_SPECIALISTS.getValue(),
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_NAILS_SPA_SPECIALISTS.getValue());
    }
}
