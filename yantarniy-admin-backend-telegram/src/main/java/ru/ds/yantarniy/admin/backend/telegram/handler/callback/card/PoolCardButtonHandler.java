...
public class PoolCardButtonHandler implements BotCallbackHandler {
    ...
    public boolean isApplicable(String callback) {
        return CallbackValue.OPEN_POOL_CARD_INFO.getValue().equals(callback);
    }
}
