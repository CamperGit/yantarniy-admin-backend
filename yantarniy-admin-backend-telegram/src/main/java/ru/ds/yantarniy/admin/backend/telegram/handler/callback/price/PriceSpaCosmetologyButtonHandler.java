...
public class PriceSpaCosmetologyButtonHandler implements BotCallbackHandler, ScrollHelperService<PriceEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<PriceEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_SPA_PRICE_COSMETOLOGY.getValue(),
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_SPA_PRICE_COSMETOLOGY.getValue());
    }
}
