...
public class CoachGroupActivityButtonHandler implements BotCallbackHandler, ScrollHelperService<EmployeeEntity> {
    ...
    public InlineKeyboardMarkup getNotEmptyScrollResponseReplyMarkup(ScrollResponse<EmployeeEntity> scrollResponse) {
        ...
        return markupService.getScrollMenuMarkup(
                ...
                CallbackValue.OPEN_FITNESS_GROUP_COACHES.getValue(),
    ...
    public List<Specification<EmployeeEntity>> getAdditionalSpecifications() {
        return Collections.singletonList(
                Specifications.inOrReturnNull("location.type", Collections.singletonList(LocationType.GROUP_ACTIVITY.getCode()))
        );
    }
    ...
    public boolean isApplicable(String callback) {
        return callback.contains(CallbackValue.OPEN_FITNESS_GROUP_COACHES.getValue());
    }
}
